...
def remove_blue(imag, thvalue, normval, itera,kerne, areamin, areamax, normval2):
        ...
        norm = cv2.normalize(grw, None, normval2,normval, cv2.NORM_MINMAX)
        blur = cv2.blur(norm, (15,15))
        _,mm1 = cv2.threshold(blur, thvalue,255,cv2.THRESH_BINARY)
        ...
        for cnt in large_contours:
                ...
                frame_out = cv2.rectangle(ima2, (x, y), (x+w, y+h), (0, 0, 200), 3)
